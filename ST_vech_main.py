...
<style>
    ...
    .styles_streamlitAppContainer__w82h8.styles_stateContainer__CelYF.a{
        visibility:hidden; 
    }
...
def main():
    ...
    subtype = st.selectbox(f"Select the subtype of {vehicle_type}:", SUBTYPE_NAMES[VEHICLE_TYPES.index(vehicle_type)])

    # Input current and last recorded kilometers
    current_kilometers = st.number_input(f"Enter the current kilometers of the {subtype} {vehicle_type}:")
